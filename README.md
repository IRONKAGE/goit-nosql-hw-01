...
1. Спроєктувати схему в MongoDB, зрозуміти різницю між вкладеними об’єктами та плоскою структурою
2. Навчитися писати запити з фільтрацією, проєкціями та операторами масивів
